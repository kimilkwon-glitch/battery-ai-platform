...
export const CUSTOMER_SERVICE_FAQ_ITEMS: CustomerServiceFaqItem[] = [
  ...
  {
    id: "cs-faq-consultation-lookup",
    category: "조회",
    question: "상담 주문 요청은 어디서 확인하나요?",
    answer:
      "상담 주문 요청 완료 후 발급된 접수번호와 접수 시 입력한 연락처로 조회할 수 있습니다. 상담 주문 요청 조회 메뉴에서 확인해 주세요. 접수번호를 잊으신 경우 고객센터로 문의해 주세요.",
  },
  {
    id: "cs-faq-consultation-number-lost",
    category: "조회",
    question: "접수번호를 잊어버렸어요.",
    answer:
      "주문자명, 연락처, 차량 정보 등을 확인한 뒤 고객센터에서 조회를 도와드릴 수 있습니다. 본인 확인을 위해 일부 정보 확인이 필요할 수 있습니다.",
  },
  {
    id: "cs-faq-consultation-vs-order",
    category: "조회",
    question: "상담 주문 요청 조회가 실제 주문조회인가요?",
    answer:
      "아닙니다. 상담 주문 요청 조회는 배터리 규격과 주문 조건 확인을 위한 상담 접수 상태 조회입니다. 실제 결제·배송 주문조회는 결제/주문 시스템 연동 후 별도로 안내됩니다.",
  },
  {
    ...
    answer:
      "회원 주문은 마이페이지 또는 주문 내역 메뉴에서 확인할 수 있습니다. 비회원 결제 주문은 주문번호와 주문 비밀번호로 조회합니다. 상담 접수만 하신 경우에는 상담 주문 요청 조회를 이용해 주세요.",
  },
  {
    id: "cs-faq-guest-lookup",
    category: "조회",
    question: "비회원 주문 내역은 어떻게 조회하나요?",
    answer:
      "비회원 주문은 주문 완료 시 안내된 주문번호와 주문 비밀번호로 조회할 수 있습니다. 주문번호를 잊으신 경우 고객센터로 문의해 주세요.",
  },
  {
    id: "cs-faq-guest-forgot",
    category: "조회",
    question: "비회원 구매 후 주문번호나 비밀번호를 기억하지 못하면 어떻게 하나요?",
    answer:
