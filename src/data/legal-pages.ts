  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "상품문의/Q&A: 상품 정보 제공 및 고객 응대 이력 관리를 위해 계속 보관될 수 있음 (공개 영역에서는 작성자명 등 개인정보 마스킹)",
        "일반 상담문의: 접수일(또는 최종 수정일) 기준 6개월 경과 후 비식별 처리",
        "배터리톡 상담 내역: 마지막 상담일(또는 최종 수정일) 기준 1년 경과 후 비식별 처리",
        "관계 법령상 보관이 필요한 정보 또는 주문·분쟁 처리에 필요한 최소 정보는 해당 기간 동안 별도 보관될 수 있음",
      ],
      paragraphs: [
...
export const SHIPPING_RETURNS_PAGE: LegalPageData = {
  ...
  sections: [
    ...
    {
      heading: "단순 변심 반품·배송비",
      bullets: [
        `택배 주문 기본 택배비는 ${DELIVERY_FEE.toLocaleString("ko-KR")}원입니다.`,
        "단순 변심 반품 시 왕복 배송비 또는 반품 배송비가 환불금에서 차감될 수 있습니다.",
        "반품 수거가 필요한 경우 수거비가 별도로 발생할 수 있으며, 상품·지역·수령 방식에 따라 안내드립니다.",
    ...
    },
    {
      heading: "파손·불량·오배송",
      bullets: [
        "배송 중 파손, 제품 불량, 규격·단자 오배송, 오배송(다른 상품 수령)이 확인되면 교환·환불을 안내드립니다.",
        "장착·사용 전 빠른 연락과 사진·운송장 정보 제공을 권장합니다.",
        "확인 결과에 따라 추가 배송비 없이 교환·환불이 진행될 수 있습니다.",
      ],
    },
    {
      heading: "환불 처리 시점",
      bullets: [
        "반품 상품 확인 후 환불 여부와 금액을 안내드립니다.",
        "환불 승인 후 결제수단·카드사·은행 기준에 따라 실제 입금까지 영업일 기준 수일이 소요될 수 있습니다.",
        "부분 환불·배송비 차감·폐전지 미반납 추가금 등은 정책과 주문 조건에 따라 반영됩니다.",
        "환불 진행 상황은 고객센터 및 주문 조회·마이페이지 안내를 통해 확인할 수 있습니다.",
      ],
    },
    {
      heading: "주문 변경·취소",
