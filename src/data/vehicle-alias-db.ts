...
import { vehicleAliasDbChevroletEntries } from "./vehicle-alias-chevrolet-supplement";
...
const vehicleAliasDbV01Core: VehicleAliasEntry[] = [
  ...
  },
  {
    ...
    displayAliases: ['아반떼 AD', 'AD 아반떼', '아반떼 스포츠'],
  ...
  },
  {
    ...
    yearRange: '2014-2019',
    generationCode: 'LF',
    displayAliases: ['쏘나타 LF', 'LF 쏘나타', '쏘나타 뉴라이즈'],
  ...
  },
  {
    ...
    yearRange: '2019-현재',
    generationCode: 'DN8',
    displayAliases: ['쏘나타 DN8', 'DN8 쏘나타', '디 엣지'],
  ...
  },
  {
    ...
    yearRange: '2018-2025',
    generationCode: 'LX2',
    displayAliases: ['팰리세이드', '더 뉴 팰리세이드'],
  ...
  // =========================================================
  {
    ...
    displayAliases: ['K3', 'K3 쿱', 'K3 쿠페', 'K3 유로'],
...
export const vehicleAliasDbV01: VehicleAliasEntry[] = applyVehicleAliasV03Augments([
  ...
  ...vehicleAliasDbChevroletEntries,
]);
