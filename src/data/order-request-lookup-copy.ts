...
export const ORDER_REQUEST_LOOKUP_COPY = {
  pageTitle: "상담 접수 조회",
  pageDescription: "상담 접수번호와 연락처로 문의 접수 상태를 확인합니다.",
  formTitle: "상담 접수 조회",
  formDescription: "상담 접수번호와 연락처를 입력해 주세요.",
  orderNumberLabel: "상담 접수번호",
  requestNumberPlaceholder: "BM-20260530-0001",
  phoneLabel: "연락처",
  phonePlaceholder: "010-0000-0000",
  hint: "접수번호를 모르시면 고객센터로 문의해 주세요.",
  submitLabel: "조회하기",
  loading: "접수 정보를 확인하는 중입니다.",
  notFoundTitle: "상담 접수 내역을 찾을 수 없습니다",
  notFoundBody:
    "상담 접수번호와 연락처를 다시 확인해 주세요. 결제·주문 조회는 주문 조회 메뉴를 이용해 주세요.",
  usedBatteryNote: "폐전지 반납 여부에 따라 금액과 회수 절차가 달라질 수 있습니다.",
  nextGuideTitle: "다음 안내",
  resultStatusKicker: "접수 상태",
  orderNumberResultLabel: "상담 접수번호",
  orderDateLabel: "접수일",
} as const;
