...
export const ROCKET_SPECS: BatteryBrandSpec[] = [
  ...
  makeSpec({
    code: "GB57820",
    normalizedCode: "DIN78L",
    brand: "ROCKET",
    productName: "GB57820",
    aliases: ["GB57820", "57820", "DIN78L", "DIN74L", "DIN H6"],
    family: "DIN",
    capacityAh20Hr: 78,
    cca: 660,
    rc: 140,
    ...
    terminalType: "DIN",
    sourceNote:
      "사용자 제공 로케트 제원표 및 공개 스펙 기준. RC 140, CCA 660, 277×175×190 확인. weightKg는 공식 확인 전 미사용.",
    fieldConfidence: {
      rc: "public_spec",
      weightKg: "unknown",
    },
    missingFields: ["weightKg"],
    cautionNotes: ["57412(74Ah)와 품번·Ah 체급이 다름 — ISG 차량 AGM 유지 여부 우선"],
  }),
