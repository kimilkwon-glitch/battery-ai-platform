...
export default function RootLayout({
  ...
  return (
    <html lang="ko" data-build-version={BUILD_STAMP} data-build-rev="home-logo-banner-faq-v1-20260529" className={cn("font-sans", geist.variable)}>
      <body className="antialiased" data-build-version={BUILD_STAMP} data-build-rev="home-logo-banner-faq-v1-20260529">
        <CartProvider>
          {children}
          <FloatingActionDock />
          <BuildVersionStamp />
