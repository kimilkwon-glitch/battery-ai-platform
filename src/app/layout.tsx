...
export default function RootLayout({
  ...
  return (
    <html lang="ko" data-build-version={BUILD_STAMP} data-build-rev="home-search-main-v1-20260528" className={cn("font-sans", geist.variable)}>
      <body className="antialiased" data-build-version={BUILD_STAMP} data-build-rev="home-search-main-v1-20260528">
        <CartProvider>
          {children}
          <BuildVersionStamp />
        </CartProvider>
