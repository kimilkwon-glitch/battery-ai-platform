...
export default function RootLayout({
  ...
  return (
    <html lang="ko" data-build-version={BUILD_STAMP} data-build-rev="benefit-triple-hero-v1-20260530" className={cn("font-sans", geist.variable)}>
      <body className="antialiased" data-build-version={BUILD_STAMP} data-build-rev="benefit-triple-hero-v1-20260530">
        <CartProvider>
          {children}
          <FloatingActionDock />
          <BuildVersionStamp />
