...
export const PRIORITY_QNA_CATALOG: QnaCatalogEntry[] = [
  ...
  },
  {
    ...
    tags: ["90R", "100R", "포터2"],
    relatedBatteryCodes: ["90R", "100R"],
    relatedSearchQueries: ["포터2 배터리", "포터2 90R/100R"],
    questionType: "상용차",
    ctaType: "photo",
    priority: 85,
    updatedAt: "2026-05-28",
  },
  {
    ...
    relatedSearchQueries: ["포터2 90R/100R", "포터2 배터리"],
    questionType: "단자 방향",
    priority: 83,
    updatedAt: "2026-05-28",
  },
  ...
  },
  {
    ...
    tags: ["AGM95L", "쏘렌토", "SUV"],
    batteryCode: "AGM95L",
    relatedBatteryCodes: ["AGM95L", "AGM105L"],
    relatedSearchQueries: ["AGM95L", "쏘렌토 MQ4 배터리"],
    updatedAt: "2026-05-28",
  },
  {
