...
const ALIAS_RULES: AliasRule[] = [
  ...
  { label: "스포티지 NQ5", brand: "기아", pattern: /스포티지\s*NQ5|NQ5\s*스포티지|스포티지\s*5\s*세대/i, dbQuery: "스포티지" },
  ...
  { label: "봉고3", brand: "기아", pattern: /봉고\s*3|봉고3|Bongo\s*3|3\s*세대\s*봉고/i, dbQuery: "봉고3" },
  { label: "EV6 CV", brand: "기아", pattern: /EV6\s*CV|CV\s*EV6/i, dbQuery: "EV6" },
  ...
  { label: "EV6", brand: "기아", pattern: /\bEV6\b/i, dbQuery: "EV6" },
