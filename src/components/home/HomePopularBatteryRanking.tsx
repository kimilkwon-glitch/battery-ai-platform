    ...
    >
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {HOME_POPULAR_BATTERIES.map((item) => (
          <article className={`${bm.cardInteractive} flex flex-col overflow-hidden`} key={item.code}>
            <div className="p-2">
            ...
            <div className="flex flex-1 flex-col gap-2 border-t border-slate-100 p-3">
              ...
              <div className="mt-auto flex flex-wrap gap-2 pt-1">
                <Link className={`${bm.btnSecondary} text-[10px]`} href={batteryDetailHref(item.code)}>
                  규격 상세
                </Link>
