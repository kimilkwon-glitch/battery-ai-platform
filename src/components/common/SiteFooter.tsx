...
import { HUB_REVIEWS, HUB_SHOP } from "@/lib/customer-hub-routes";
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-start">
        <div className="space-y-3">
          ...
          <dl className="grid gap-1.5 text-[11px] font-medium text-slate-600 sm:grid-cols-2">
            <div>
              <dt className="inline font-bold text-slate-500">대표자 </dt>
            ...
            <div>
              <dt className="inline font-bold text-slate-500">운영시간 </dt>
              <dd className="inline">{formatBusinessField(biz.businessHours, "평일 09:00–18:00 (점심 12:00–13:00)")}</dd>
            </div>
          </dl>
